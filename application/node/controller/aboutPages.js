...
router.get('/', lazyReg.removeLazyRegistrationObject, search.getSearchCategories,  (req, res) => {
    res.render("about")
});
...
router.get('/ckRobinson', lazyReg.removeLazyRegistrationObject, search.getSearchCategories, (req, res) => {
    res.render('about/ckRobinson')
})
router.get('/dsElnaggar', lazyReg.removeLazyRegistrationObject, search.getSearchCategories, (req, res) => {
    res.render('about/dsElnaggar')
})
router.get('/jamespratt', lazyReg.removeLazyRegistrationObject, search.getSearchCategories, (req, res) => {
    res.render('about/jamespratt')
})
router.get('/rKung', lazyReg.removeLazyRegistrationObject, search.getSearchCategories, (req, res) => {
    res.render('about/rKung')
})
router.get('/snehalP', lazyReg.removeLazyRegistrationObject, search.getSearchCategories, (req, res) => {
    res.render('about/snehalP')
})
router.get('/srRoy', lazyReg.removeLazyRegistrationObject, search.getSearchCategories, (req, res) => {
